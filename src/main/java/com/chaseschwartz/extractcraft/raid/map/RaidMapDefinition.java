...
public record RaidMapDefinition(String id, String name, ResourceKey<Level> dimension, RaidPlatform platform, Vec3 playerSpawn,
        float playerSpawnYaw, float playerSpawnPitch, List<RaidLootChest> lootChests, List<RaidMobSpawn> mobSpawns,
        List<RaidExtractionZone> extractionZones, int raidDurationTicks, RaidMapSource source, boolean renderExtractionMarkers) {
