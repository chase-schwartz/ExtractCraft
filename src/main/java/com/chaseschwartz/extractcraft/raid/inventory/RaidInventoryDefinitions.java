...
public class RaidInventoryDefinitions {
    private static final Map<String, BackpackDefinition> BACKPACKS = Map.of(
            "no_backpack", new BackpackDefinition("no_backpack", "No Backpack", 0, 0.0D),
            "small_backpack", new BackpackDefinition("small_backpack", "Small Backpack", 16, 20.0D),
            "medium_backpack", new BackpackDefinition("medium_backpack", "Medium Backpack", 25, 35.0D),
            "large_backpack", new BackpackDefinition("large_backpack", "Large Backpack", 36, 50.0D));
    ...
    private static final SafeContainerDefinition ALPHA_SAFE_BOX = new SafeContainerDefinition("alpha_safe_box", "Alpha Safe Box", 4, 8.0D);
